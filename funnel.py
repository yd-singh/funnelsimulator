...
class Funnel:
    ...
    def run_funnel(self, customers_count):
        ...
        summary_stats = (
            ...
            f"- **Average Cost/User:** ₹{average_cost_per_customer:.2f}\n"
            f"- **Average Time/User:** {average_time_per_customer_minutes:.2f} secs"
        )
        ...
        print(f"Average Time per Customer: {average_time_per_customer_minutes:.2f} secs")
